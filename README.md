...
Connected to my Storm Spotting role, I also vounteer with a local Animal Response Team under the direction of the Butler County, KS [Emergency Management Agency](https://www.bucoks.com/206/Emergency-Management). Our main post-disaster role is setting up and managing shelters for companion animals (mostly dogs and cats, but birds and exotics too). I am also developing a logistics management tool for Emergency Management, AccSYS, which is currently in a private repo but will be made public in the future. This, too, is a Node project, moving paper- and spreadsheet-based logistics managment into the cloud.
